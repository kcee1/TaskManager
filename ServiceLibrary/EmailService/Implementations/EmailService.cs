...
namespace ServiceLibrary.EmailService.Implementations
{
    public class EmailService : IEmailService
    {
        ...
        public EmailService(EmailDetails settings)
        {
            _settings = settings;
        }
        ...
        public string GetEmailTemplate<T>(T emailTemplateModel, string path)
        {
            string mailTemplate = LoadTemplate(path);
