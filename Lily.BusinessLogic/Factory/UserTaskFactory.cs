...
namespace TaskManager.BusinessLogic.Factory
{
	...
	/// UserTask Factory
	/// </summary>
	/// <remarks>Responsible for handling action which have to with validating UserTask DTO</remarks>
	public class UserTaskFactory
	{
		/// <summary>
		/// Validate User Task model
		/// </summary>
		...
		public bool ValidateModel(UserTaskDTO model, bool isUpdate, long id, out string errorMsg)
		{
